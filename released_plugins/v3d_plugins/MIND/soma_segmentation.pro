...
HEADERS += pcaAnalysis.h
HEADERS += probability_model_vis.h
HEADERS += soma_simulation.h
SOURCES += soma_segmentation_plugin.cpp
SOURCES += ResolutionDialog.cpp
SOURCES += pcaAnalysis.cpp
SOURCES += probability_model_vis.cpp
SOURCES += soma_simulation.cpp
